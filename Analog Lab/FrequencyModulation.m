...
plot(t,Sc)% - Plots the carrier signal waveform Sc against the time t.
...
ubplot(3,1,3) %sets up the subplot window to show the modulated signal, which will be the third plot (in the third row) in a 3-row, 1-column grid of plots.

plot(t,V)% plots the modulated signal against the time axis 't' in the same figure window.
